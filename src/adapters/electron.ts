...
export const electronBackend: ApiBackend = {
    ...
    updateProgram: async () => ({} as any),
    deleteProgram: async () => {},
    updateProgramPhase: async () => ({} as any),
    deleteProgramPhase: async () => {},
    updateProgramDay: async () => ({} as any),
    deleteProgramDay: async () => {},
    createProgramExercise: async () => ({} as any),
    updateProgramExercise: async () => ({} as any),
    deleteProgramExercise: async () => {},
    getUserPrograms: async () => [],
    startProgram: async () => ({} as any),
    updateUserProgram: async () => {},
    deleteUserProgram: async () => {},
    deleteUserProgramsForProgram: async () => {},
    ...
    getAllExerciseLogsForProgram: async () => [],
