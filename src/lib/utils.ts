...
/** True while any Radix dialog/alert-dialog is open. Mode-level Escape
 *  handlers must yield to it — one Escape press closes one layer, never the
 *  dialog AND the whole mode underneath it. */
